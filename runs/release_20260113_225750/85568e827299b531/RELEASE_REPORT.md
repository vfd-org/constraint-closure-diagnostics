# Release Report: bridge_run_20260113_225750

**Run Hash:** `85568e827299b531`
**Generated:** 2026-01-13T22:57:58.673526
...
## Bridge Axiom Results

| Metric | Value |
|--------|-------|
| Mode | BA |
| Zeros Compared | N/A |
| Correlation | 0.999945 |
| Rank Correlation | 0.999731 |
| RMSE | 1098.0259 |
| Mean Beta | 0.500000 |
...
```bash
rhdiag run --seed 42 --cell-count 64 --internal-dim 96 --propagation-range 3 --bridge-mode BA
```

---

*Report generated by VFD Proof Dashboard v1.0*
*Timestamp: 2026-01-13T22:57:58.932866*